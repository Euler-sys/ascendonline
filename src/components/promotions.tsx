...
const promotions = [
  {
    ...
    description:
      "With Ascend Federal Credit Union’s Central Plus Checking, receive up to $800 if your phone is stolen or damaged.",
  ...
  },
  {
    ...
    description:
      "Check your credit score anytime, anywhere with Ascend Federal Credit Union’s FREE mobile and online banking tool.",
    buttonText: "LEARN MORE",
    imageUrl: img2,
  },
  {
    ...
    description:
      "Take control of your student loans — enroll in Ascend Federal Credit Union’s FREE Managing Student Loans course!",

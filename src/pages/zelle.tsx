    ...
    <>
      <div className="min-h-screen bg-white p-4 space-y-4 max-w-md mx-auto font-sans">
        ...
        <div className="text-center text-lg font-semibold">
          Send or receive money with
        </div>
        <div className="w-[100px] m-auto">
          <img src={zelle} alt="" />
        </div>
        <p className="text-center text-sm text-gray-500">
          or send to other Ascend Federal Credit Union you’ve added
        </p>

        {/* Alert */}
        <div className="bg-gray-100 p-3 rounded-md">
          <p className="text-sm font-semibold">
            Stay alert: online seller scams
          </p>
          <p className="text-xs text-gray-600">
            Treat Zelle<sup className="text-xs">®</sup> like cash – once you
            send it, you're unlikely to get it back.
          </p>
        ...
        <div className="flex  justify-around items-center  p-4 rounded-md">
          <div className="text-center">
            <div className="w-16 h-16  rounded-full  flex  flex-col items-center justify-center mx-auto">
              ...
              <div className="w-12 h-12  rounded-full flex items-center justify-center text-blue-700 font-semibold">
                Pay
              </div>
            </div>
          </div>
